...
class FastScroller extends RecyclerView.ItemDecoration implements RecyclerView.OnItemTouchListener {
    ...
    private void drawVerticalScrollbar(Canvas canvas) {
        ...
        int top = new_mVerticalThumbCenterY - mVerticalThumbDrawable.getIntrinsicHeight() / 2;

        mVerticalThumbDrawable.setBounds(0, 0, mVerticalThumbWidth,
                mVerticalThumbDrawable.getIntrinsicHeight());
    ...
    void updateScrollPosition(int offsetX, int offsetY) {
        ...
        if (mNeedVerticalScrollbar) {
            ...
            int height = mVerticalThumbDrawable.getIntrinsicHeight();
            new_mVerticalThumbCenterY = (int)(
                    (verticalVisibleLength - height) * offsetY /
                    (verticalContentLength - verticalVisibleLength) + height / 2.0f);
        }
        if (mNeedHorizontalScrollbar) {
    ...
    public boolean onInterceptTouchEvent(@NonNull RecyclerView recyclerView,
        ...
        Log.e("action", String.valueOf(ev.getAction()));
    ...
    boolean isPointInsideVerticalThumb(float x, float y) {
        ...
        return (isLayoutRTL() ? x <= mVerticalThumbDrawable.getIntrinsicHeight()
                : x >= mRecyclerViewWidth - mVerticalThumbWidth)
                && y >= new_mVerticalThumbCenterY - mVerticalThumbDrawable.getIntrinsicHeight()/2
                && y <= new_mVerticalThumbCenterY + mVerticalThumbDrawable.getIntrinsicHeight()/2;
